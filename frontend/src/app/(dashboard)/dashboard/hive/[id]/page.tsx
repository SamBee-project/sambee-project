        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <Badge className={getHealthColor(hive.health)} variant="outline">
                {hive.health}
              </Badge>
            </div>
                    ...
                    <div>
                      ...
                      <div className="h-2 bg-gray-800 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{ width: `${(hive.temperature / 40) * 100}%` }}
                        />
                      </div>
                      ...
                      <CardContent className="space-y-4">
                        <div className="grid md:grid-cols-3 gap-4">
                          <div className="bg-black/30 p-3 rounded-lg border border-yellow-500/10">
                            <p className="text-sm text-gray-400">Queen Seen</p>
                          ...
                          <div className="bg-black/30 p-3 rounded-lg border border-yellow-500/10">
                            <p className="text-sm text-gray-400">Temperament</p>
